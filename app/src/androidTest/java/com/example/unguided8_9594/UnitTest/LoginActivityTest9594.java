...
import com.example.unguided8_9594.R;
...
public class LoginActivityTest9594 {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void loginActivityTest9594() {
        ...
        ViewInteraction textInputEditText5 = onView(
                allOf(withId(R.id.loginPassword),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText5.perform(replaceText("admin"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText6 = onView(
                allOf(withId(R.id.loginNim),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textInputEditText6.perform(replaceText("admins"), closeSoftKeyboard());
        ...
        ViewInteraction textInputEditText10 = onView(
                allOf(withId(R.id.loginPassword), withText("admin"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textInputEditText10.perform(replaceText("admins"));
